...
# Makefile for running tests across Java, Python implementations

.PHONY: help test test-java test-python test-shared clean
...
# Run all tests
test: test-shared test-java test-python
	@echo ""
...
quick-test: test-java test-python
